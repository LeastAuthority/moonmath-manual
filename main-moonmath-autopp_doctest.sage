r"""
This file was *autogenerated* from main-moonmath-autopp.tex with sagetex.sty
version 2020/08/12 v3.5. It contains the contents of all the
sageexample environments from main-moonmath-autopp.tex. You should be able to
doctest this file with "sage -t main-moonmath-autopp_doctest.sage".
