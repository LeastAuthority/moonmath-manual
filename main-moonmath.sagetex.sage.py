...
_sage_const_1252 = Integer(1252); _sage_const_65 = Integer(65); _sage_const_1261 = Integer(1261); _sage_const_1325 = Integer(1325); _sage_const_66 = Integer(66); _sage_const_1332 = Integer(1332); _sage_const_1357 = Integer(1357); _sage_const_67 = Integer(67); _sage_const_1364 = Integer(1364)## This file (main-moonmath.sagetex.sage) was *autogenerated* from main-moonmath.tex with sagetex.sty version 2020/08/12 v3.5.
import sagetex
