...
\end{comment}
How much mathematics do you need to understand \href{https://en.wikipedia.org/wiki/Zero-knowledge_proof}{zero-knowledge proofs}? The answer, of course, depends on the level of understanding you aim for. It is possible to describe zero-knowledge proofs without using any mathematics at all; however, to read a foundational paper like \cite{Groth16} and to understand the internals of \href{https://z.cash/technology/zksnarks/}{SNARK} implementations, some knowledge of mathematics is needed. 
