...
sage: Perm_F13_k4 = [MimC(x,4) for x in L_F13] # key=4
sage: Perm_F13_k1 = [MimC(x,1) for x in L_F13] # key=1
sage: L_F13
sage: Perm_F13_k4
sage: Perm_F13_k1
\end{sagecommandline}
...
\EndFor
\State \textbf{return} $H_k$ \Comment{finalize}
\EndProcedure
\end{algorithmic}
\end{algorithm}
