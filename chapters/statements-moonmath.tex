...
\end{example}
\begin{example} To consider a more general transformation, we consider the tiny-jubjub circuit from example \ref{ex:TJJ-circuit_2} again. A proper circuit is given by the following graph, where we highlighted all nodes that contribute a constraint to the R1CS:
\begin{center}
