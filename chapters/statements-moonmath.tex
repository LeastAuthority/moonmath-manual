\chapter{Statements}\label{sec:statements}
...
\begin{example}[$3$-factorization] Consider our $3$-factorization problem from equation \ref{C3fac}\sme{check reference} and the associated circuit $C_{3.fac}(\F_{13})$. Out task is to transform this circuit into an equivalent rank-1 constraint system.
\begin{center}
\digraph[scale=0.5]{G1}{
	forcelabels=true;
	//center=true;
...
\begin{equation}\label{R3-fac-zk}
\begin{split}
