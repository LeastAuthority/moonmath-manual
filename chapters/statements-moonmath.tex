...
\end{tabular}
\end{center}
We can invoke sage to verify our computation. In sage every polynomial ring has a function \texttt{lagrange\_polynomial} that takes the defining points as inputs and the associated Langrange polynomial as output.
...
Combining this computation, together with the target polynomial we derive earlier, a quadratic arithmetic program associated to the rank-1 constraint system $R_{3.fac\_zk}$ is given by
\begin{multline*}
