...
\includeonly{chapters/ops-notes-moonmath,chapters/circuit-compilers-moonmath}
...
\newcommand{\inclonlytext}[1]{{\Large NB: This PDF only includes the Circuit Compilers chapter}
}
