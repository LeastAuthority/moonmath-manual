...
%pdflatex --file-line-error --synctex=1 --enable-write18 --shell-escape
 %2.) Execute Sage:
%     a.) build latex
%     b.) run the generate_sagetex_file.sh script in this folder
%
...
\include{chapters/algebraic-hash-functions-moonmath}
\include{chapters/polynomial-commitments-moonmath}
