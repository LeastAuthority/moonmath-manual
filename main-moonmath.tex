...
\includeonly{chapters/ops-notes-moonmath,chapters/zk-protocols-moonmath}
...
\newcommand{\inclonlytext}[1]{{\Large NB: This PDF only includes the Zero-Knowledge Protocols chapter}
}
